...
class InterfaceQueryDb:
    ...
    @abstractmethod
    def ajout_element_en_fin_de_courbe_de_charge(self, timestamp: dt.datetime, model, identifiants_sites: [str], *args, **kwargs):
        raise NotImplemented()

    @abstractmethod
    def write(self, date_debut: dt.datetime, date_fin: dt.datetime, model, identifiants_sites: [str], *args, **kwargs):
        raise NotImplemented()
