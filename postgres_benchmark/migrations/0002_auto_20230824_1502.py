# Generated by Django 4.2.2 on 2023-08-24 15:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        psqlextra.backend.migrations.operations.create_partitioned_model.PostgresCreatePartitionedModel(
            name='TimeSerieElementIndexationHorodate',
            fields=[
            ...
            options={
                'ordering': ['horodate'],
                'indexes': [django.contrib.postgres.indexes.BrinIndex(fields=['horodate'], name='postgres_be_horodat_d80fbd_brin', pages_per_range=24)],
            },
